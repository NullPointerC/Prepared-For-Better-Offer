...
![image-20220310145028084](http://static.codenote.xyz/img/20220310145028.png)
...
![image-20220310145308510](http://static.codenote.xyz/img/20220310145308.png)
...
![image-20220313222401796](http://static.codenote.xyz/img/20220313222401.png)
...
![image-20220313222555380](http://static.codenote.xyz/img/20220313222555.png)

#### 虚引用

定义完成后，就无法通过该引用获取指向的对象，为对象设置虚引用的唯一目的，就是希望能在这个对象被回收时，收到一个系统通知，起到哨兵作用。

虚引用与软引用和弱引用的一个区别在于，虚引用必须和引用队列（ReferenceQueue）联合使用。当垃圾回收器准备回收一个对象时，如果发现它还有虚引用，就会在回收对象的内存之前，把这个虚引用加入到与之关联的引用队列中。

![image-20220313222643475](http://static.codenote.xyz/img/20220313222643.png)
...
![image-20220310150056283](http://static.codenote.xyz/img/20220310150056.png)
...
![image.png](http://static.codenote.xyz/img/20220310151321.webp)
...
![image.png](http://static.codenote.xyz/img/20220310151758.webp)

#### 复制算法

它将可用内存按容量划分为大小相等的两块，每次只使用其中的一块。当这一块的内存用完了，就将还存活着的对象复制到另外一块上面，然后再把已使用的内存空间一次清理掉，这样一来就不容易出现内存碎片的问题。

![image.png](http://static.codenote.xyz/img/20220310151924.webp)
...
![image.png](http://static.codenote.xyz/img/20220310152457.webp)

### 分别说说这四种算法的特点以及在哪使用?

![image.png](http://static.codenote.xyz/img/20220310153703.webp)
...
![image-20220310160606712](http://static.codenote.xyz/img/20220310160606.png)
...
![img](http://static.codenote.xyz/img/20220310172307.webp)
...
![image.png](http://static.codenote.xyz/img/20220310174739.webp)

<hr/>

![image-20220310180229464](http://static.codenote.xyz/img/20220310180229.png)
...
![image.png](http://static.codenote.xyz/img/20220310173218.webp)
...
![image.png](http://static.codenote.xyz/img/20220310173347.webp)
...
![image.png](http://static.codenote.xyz/img/20220310174129.webp)
...
![image.png](http://static.codenote.xyz/img/20220310174214.webp)
...
**CMS收集器收集日志如下：** ![image.png](http://static.codenote.xyz/img/20220310174236.webp) **CMS收集器工作过程如图所示：**

![image.png](http://static.codenote.xyz/img/20220310174246.webp)
...
![image.png](http://static.codenote.xyz/img/20220311223320.webp)
...
![image.png](http://static.codenote.xyz/img/20220311223345.webp)
...
![image-20220311225903825](http://static.codenote.xyz/img/20220311225903.png)
...
![image-20220313205137451](http://static.codenote.xyz/img/20220313205137.png)
